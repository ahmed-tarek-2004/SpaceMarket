...
namespace Ecommerce.DataAccess.Services.Payment
{
    public class PaymentService : IPaymentService
    {
        ...
        .Include(o => o.Items)
            .ThenInclude(i => i.Service)
            .ThenInclude(s => s.Provider)
        .Where(o => o.Items.Any(i => i.Service.ProviderId == providerId))
        .AsSplitQuery()
        .AsNoTracking()
        ...
        .ToListAsync();
                ...
                return _responseHandler.Success(orders, "Orders retrieved successfully with payment details.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<Response<List<TransactionResponse>>> GetAdminAllTransactionsAsync(TransactionStatus? status, DateTime? from, DateTime? to)
        {
            try
            {
                ...
                return _responseHandler.Success(response, "Get All Transactions");
            }
            catch (Exception ex)
            {
